...
export const commCtrlSystem: FuzzySystem = {
  ...
  output: {
    ...
    terms: [
      ...
      { id: "Medium",    nameKey: "terms.mediumM",      color: COLOR.outputMedium,    shape: { kind: "triangle", points: [25, 50, 75] } },
      { id: "Large",     nameKey: "terms.largeM",       color: COLOR.outputHigh,      shape: { kind: "triangle", points: [50, 75, 100] } },
      { id: "VeryLarge", nameKey: "terms.veryLargeM",   color: COLOR.outputVeryHigh,  shape: { kind: "triangle", points: [75, 100, 100] } },
    ],
  },
  rules,
};
