...
export const routingSystem: FuzzySystem = {
  ...
  output: {
    ...
    terms: [
      ...
      { id: "High",     nameKey: "terms.highM",     color: COLOR.high,     shape: { kind: "gaussian", bias: 70,  sigma: 15 } },
      { id: "VeryHigh", nameKey: "terms.veryHighM", color: COLOR.veryHigh, shape: { kind: "gaussian", bias: 100, sigma: 10 } },
    ],
  },
  rules,
};
